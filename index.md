...
funded. Those decisions increasingly pass through AI systems. This course teaches you to work inside that
process: frame an urban problem, use approved AI tools to analyze it, test more than one scenario, audit what
the AI told you, and communicate a recommendation that a non-technical stakeholder can act on and contest.

You will finish with an **Urban AI Decision-Support Brief** — a real artifact for a real urban issue, built by
your team, with every AI use documented.

<div class="grid grid-3" style="margin:2.5rem 0">
  <div class="card">
    <span class="card-num">STRUCTURE</span>
    <h3>8 meetings, 2 hours each</h3>
...
1. Define Urban AI and AI-driven decision support systems, and explain how they support evidence-based decisions.
2. Describe how planning decisions get made — framing, stakeholders, criteria, alternatives, tradeoffs, judgment.
...
5. Design a human-centered decision-support workflow with transparent assumptions and real human review.
6. Produce a decision-support brief that demonstrates critical, ethical, and creative AI use.
